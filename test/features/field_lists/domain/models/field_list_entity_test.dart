...
void main() {
  test(
    ...
    () {
      ...
      expect(fieldListEntity.fieldId, "woehwfgehfg");
  ...
  test('FieldListEntity throws AssertionError when created with invalid name', () {
    ...
    expect(
      () => FieldListEntity(
        fieldId: "woehwfgehfg",
        name: '${"r" * FieldLists.MAXIMUM_LENGTH_OF_NAME} ',
        creationAt: DateTime(2020, 2, 20),
        lastModificationAt: DateTime(2020, 2, 20),
      ),
      throwsA(
  ...
  test(
    'FieldListEntity throws AssertionError when created with invalid sortBy',
    () {
      expect(
        () => FieldListEntity(
          fieldId: "woehwfgehfg",
  ...
  test(
    'FieldListEntity testsTypingAnswerLetterDuration has the correct value',
    () {
      final fieldListEntity = FieldListEntity(
        fieldId: "woehwfgehfg",
        name: "field list name",
  ...
  test(
    'FieldListEntity studyTillCorrectFindingAnswerDuration default value',
    () {
      final fieldListEntity = FieldListEntity(
        fieldId: "woehwfgehfg",
        name: "field list name",
