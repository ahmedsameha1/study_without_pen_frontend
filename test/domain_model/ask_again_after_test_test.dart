...
main() {
  ...
  group("_id tests", () {
    test("_id is a valid UUID", () {
      expect(() => AskAgainAfterTest("", fieldList, 0, 1, Duration()),
          throwsArgumentError);
      expect(() => AskAgainAfterTest("weuwe", fieldList, 0, 1, Duration()),
          throwsArgumentError);
      expect(() => AskAgainAfterTest(uuid.v4(), fieldList, 0, 1, Duration()),
          returnsNormally);
    });
    test("_id has been assigned the correct value", () {
      String uuidString = uuid.v4();
      final askAgainAfterTest = AskAgainAfterTest(uuidString, fieldList, 0, 1, Duration());
  ...
  group("_fieldList tests", () {
    test("_fieldList has been assigned the correct value", () {
      ...
      final askAgainAfterTest = AskAgainAfterTest(uuid.v4(), fieldList1, 0, 1, Duration());
  ...
  group("_currentQuestionCounter tests", () {
    test("_currentQuestionCounter cannot be negative", () {
      expect(() => AskAgainAfterTest(uuid.v4(), fieldList, -1, 1, Duration()),
          throwsArgumentError);
      expect(() {
        final askAgainAfterTest = AskAgainAfterTest(uuid.v4(), fieldList, 0, 1, Duration());
    ...
    test(
        "_currentQuestionCounter cannot be set to be smaller than or equal its current value",
            () {
          expect(() {
            final askAgainAfterTest = AskAgainAfterTest(uuid.v4(), fieldList, 3, 1, Duration());
  ...
  group("_triesNumber tests", () {
    test("_triesNumber cannot be smaller than one", () {
      expect(() => AskAgainAfterTest(uuid.v4(), fieldList, 0, 0, Duration()),
          throwsArgumentError);
      expect(() => AskAgainAfterTest(uuid.v4(), fieldList, 0, -1, Duration()),
          throwsArgumentError);
    });
    test("_triesNumber has been assigned the correct value", () {
      final askAgainAfterTest = AskAgainAfterTest(uuid.v4(), fieldList, 0, 3, Duration());
    ...
    test(
        "_elapsedTime cannot be set to be smaller than or equal the current value",
          ...
          expect(() {
            ...
            AskAgainAfterTest(uuid.v4(), fieldList, 0, 3, Duration(seconds: 10));
            askAgainAfterTest.elapsedTime = Duration();
          }, throwsArgumentError);
        });
