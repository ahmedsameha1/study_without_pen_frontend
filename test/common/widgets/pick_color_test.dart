  ...
  group('English locale', () {
    ...
    testWidgets('Test the precense of the main widgets',
      ...
      await tester.pumpWidget(MaterialApp(
          ...
          home: PickColor(callback: (_) {})));
      expect(find.byType(PickColor), findsOne);
      expect(
          find.descendant(of: find.byType(PickColor), matching: columnFinder),
          findsOne);
      GestureDetector gestureDetector = tester.widget(find.descendant(
          of: columnFinder, matching: find.byKey(Key("gestureDetector"))));
    ...
    testWidgets('selecting a color', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(MaterialApp(
          localizationsDelegates: [AppLocalizations.delegate],
          supportedLocales: AppLocalizations.supportedLocales,
          home: PickColor(callback: callBack.call)));
      await tester.tap(find.byKey(
        Key("stackForColorIndicator"),
      ));
      await tester.pumpAndSettle();
      ColorPicker colorPicker = tester.widget(find.descendant(
          of: find.byType(AnimatedSize), matching: find.byType(ColorPicker)));
      ...
      Text selectColorText = tester.widget(find.descendant(
