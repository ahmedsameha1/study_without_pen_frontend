...
abstract class FieldListEntity with _$FieldListEntity {
  FieldListEntity._({
    ...
    required this.testsTimeOfAnswerAction,
        ...
        assert(
            color >= FieldLists.MINIMUM_COLOR &&
                color <= FieldLists.MAXIMUM_COLOR,
        ...
        assert(testsTimeOfAnswerAction >= 0 && testsTimeOfAnswerAction < 2,
  ...
  factory FieldListEntity(
      ...
      @Default(false) bool doesObfuscateQuestion}) = _FieldListEntity;
  @override
  final String name;
  @override
  final int checkType;
