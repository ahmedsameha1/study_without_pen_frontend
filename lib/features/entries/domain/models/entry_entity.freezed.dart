...
mixin _$EntryEntity {
 ...
 String get fieldListId; String get answer; String get question; DateTime get creationAt; DateTime get lastModificationAt; int get order; bool get didAskedAtCurrentTestRound; int get rank; int get askedCount; int get wronglyAnsweredCount; DateTime? get emulatedCreatedAt;
...
@override
int get hashCode => Object.hash(runtimeType,fieldListId,answer,question,creationAt,lastModificationAt,order,didAskedAtCurrentTestRound,rank,askedCount,wronglyAnsweredCount,emulatedCreatedAt);

@override
String toString() {
  return 'EntryEntity(fieldListId: $fieldListId, answer: $answer, question: $question, creationAt: $creationAt, lastModificationAt: $lastModificationAt, order: $order, didAskedAtCurrentTestRound: $didAskedAtCurrentTestRound, rank: $rank, askedCount: $askedCount, wronglyAnsweredCount: $wronglyAnsweredCount, emulatedCreatedAt: $emulatedCreatedAt)';
}
...
@useResult
$Res call({
 String fieldListId, String answer, String question, DateTime creationAt, DateTime lastModificationAt, int order, bool didAskedAtCurrentTestRound, DateTime? emulatedCreatedAt, int rank, int askedCount, int wronglyAnsweredCount
});
...
/// Create a copy of EntryEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? fieldListId = null,Object? answer = null,Object? question = null,Object? creationAt = null,Object? lastModificationAt = null,Object? order = null,Object? didAskedAtCurrentTestRound = null,Object? emulatedCreatedAt = freezed,Object? rank = null,Object? askedCount = null,Object? wronglyAnsweredCount = null,}) {
  return _then(_self.copyWith(
fieldListId: null == fieldListId ? _self.fieldListId : fieldListId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String fieldListId,  String answer,  String question,  DateTime creationAt,  DateTime lastModificationAt,  int order,  bool didAskedAtCurrentTestRound,  DateTime? emulatedCreatedAt,  int rank,  int askedCount,  int wronglyAnsweredCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EntryEntity() when $default != null:
return $default(_that.fieldListId,_that.answer,_that.question,_that.creationAt,_that.lastModificationAt,_that.order,_that.didAskedAtCurrentTestRound,_that.emulatedCreatedAt,_that.rank,_that.askedCount,_that.wronglyAnsweredCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String fieldListId,  String answer,  String question,  DateTime creationAt,  DateTime lastModificationAt,  int order,  bool didAskedAtCurrentTestRound,  DateTime? emulatedCreatedAt,  int rank,  int askedCount,  int wronglyAnsweredCount)  $default,) {final _that = this;
switch (_that) {
case _EntryEntity():
return $default(_that.fieldListId,_that.answer,_that.question,_that.creationAt,_that.lastModificationAt,_that.order,_that.didAskedAtCurrentTestRound,_that.emulatedCreatedAt,_that.rank,_that.askedCount,_that.wronglyAnsweredCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String fieldListId,  String answer,  String question,  DateTime creationAt,  DateTime lastModificationAt,  int order,  bool didAskedAtCurrentTestRound,  DateTime? emulatedCreatedAt,  int rank,  int askedCount,  int wronglyAnsweredCount)?  $default,) {final _that = this;
switch (_that) {
case _EntryEntity() when $default != null:
return $default(_that.fieldListId,_that.answer,_that.question,_that.creationAt,_that.lastModificationAt,_that.order,_that.didAskedAtCurrentTestRound,_that.emulatedCreatedAt,_that.rank,_that.askedCount,_that.wronglyAnsweredCount);case _:
  return null;
...
@override
int get hashCode => Object.hash(runtimeType,fieldListId,answer,question,creationAt,lastModificationAt,order,didAskedAtCurrentTestRound,emulatedCreatedAt,rank,askedCount,wronglyAnsweredCount);

@override
String toString() {
  return 'EntryEntity(fieldListId: $fieldListId, answer: $answer, question: $question, creationAt: $creationAt, lastModificationAt: $lastModificationAt, order: $order, didAskedAtCurrentTestRound: $didAskedAtCurrentTestRound, emulatedCreatedAt: $emulatedCreatedAt, rank: $rank, askedCount: $askedCount, wronglyAnsweredCount: $wronglyAnsweredCount)';
}
...
/// Create a copy of EntryEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? fieldListId = null,Object? answer = null,Object? question = null,Object? creationAt = null,Object? lastModificationAt = null,Object? order = null,Object? didAskedAtCurrentTestRound = null,Object? emulatedCreatedAt = freezed,Object? rank = null,Object? askedCount = null,Object? wronglyAnsweredCount = null,}) {
