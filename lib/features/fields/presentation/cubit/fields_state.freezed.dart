...
/// @nodoc
mixin _$FieldsState {
  StateStatus get fieldsStateStatus;
...
abstract mixin class $FieldsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({StateStatus fieldsStateStatus, List<FieldEntity> fields});
}
...
class _FieldsState implements FieldsState {
  const _FieldsState(
      [this.fieldsStateStatus = StateStatus.loading,
      final List<FieldEntity> fields = const []])
      : _fields = fields;

  @override
  @JsonKey()
  final StateStatus fieldsStateStatus;
