...
abstract class StudyTillCorrect extends Session {
  ...
  StudyTillCorrect(String uuid, FieldList fieldList, List<TextEntry> entries, int currentQuestionCounter,
    ...
    final uuid = Uuid();
    try {
      entries.add(TextEntry(uuid.v4(), "question", "answer", uuid.v4(), DateTime.utc(2020, 1, 1)));
